...
const StampsMenu: React.FC<StampsMenuProps> = (targetTx: StampsMenuProps) => {
  ...
  return (
    <>
      ...
      >
        <span>
          <LoadingButton variant='contained' loading={isSending} onClick={handleStampClick} className={`plausible-event-name=Stamp+Click plausible-event-type=${targetTx.type}`}>
