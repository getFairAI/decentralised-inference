...
const RequestElement = ({ request }: { request: RequestData }) => {
  ...
  return (
    <>
                ...
                <Box>
                  ...
                  <DialogContent>
                    <Box display={'flex'} flexDirection={'column'} gap={'16px'} flexWrap={'wrap'}>
                      ...
                      <span className='whitespace-pre-wrap text-base sm:text-lg font-small'>
                        {request.links}
                      </span>
                      <Typography variant='subtitle1' sx={{ fontWeight: 'bold' }}>
                        Feedback:
                      ...
                      <Switch checked={request.keepLink} sx={{ pointerEvents: 'none' }} disabled />
                      <Box
                        display={'flex'}
                      ...
                      >
                        <Chip
                          label={request.verificationCode}
                          variant='filled'
                          color='primary'
      ...
      <List key={request.id} sx={{ padding: 0 }}>
        <ListItem sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
          <Card
            raised={true}
            elevation={1}
            sx={{ backgroundColor: '#ffffff !important', width: '100%', maxHeight: '350px' }}
          >
        ...
        <div className='w-full flex justify-center'>
          <div className='w-full max-w-[1600px] px-10 mt-10 flex flex-wrap-reverse justify-center sm:justify-between items-center font-bold gap-5'>
            <div className='gap-3 flex justify-center items-center text-lg lg:text-3xl'>
              ...
              />
              Requests for update AI solution
            </div>
            <div className='flex gap-3'>
              <a href='#/request-arbitrum-update'>
