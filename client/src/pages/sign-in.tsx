...
const WalletnotConnectedContent = () => {
  ...
  return (
    <>
      ...
      <Button sx={{ borderRadius: '8px', gap: '10px', background: '#FFF' }} onClick={handleClick} className='plausible-event-name=Onboarding+Connect+Wallet+Click'>
        <Typography
          sx={{ color: '#1F1F26' }}
          fontWeight={700}
          fontSize={'18px'}
      ...
      <Box display={'flex'} gap={'8px'}>
        ...
        <Typography display={'flex'} gap={'8px'} alignItems={'center'} noWrap>
          <a href={CREATE_WALLET_LINK} target='_blank' rel='noreferrer' className='plausible-event-name=Walle+Create+Learn+Click'>
        ...
        <Step sx={{ width: '100%' }}>
          ...
          <StepContent sx={{ width: '100%' }}>
            ...
            <Box display={'flex'} justifyContent={'flex-end'} mt={'48px'}>
              <Button variant='contained' onClick={handleNext} sx={{ mt: 1, mr: 1 }} className='plausible-event-name=Onboarding+Top+Up+U+Click'>
                Top Up $U
              </Button>
            </Box>
          </StepContent>
        ...
        <Step>
          ...
          <StepContent sx={{ width: '100%' }}>
            ...
            <Box display={'flex'} justifyContent={justifyContent} mt={'48px'}>
              <Button sx={{ mt: 1, mr: 1 }} onClick={handleBack} variant='outlined' className='plausible-event-name=Onboarding+Top+Up+AR+Click'>
                Top Up AR
              </Button>
              <Button sx={{ mt: 1, mr: 1 }} variant='contained' onClick={handleSkip} className='plausible-event-name=Explore+Marketplace'>
                Explore marketplace
              </Button>
            </Box>
          </StepContent>
