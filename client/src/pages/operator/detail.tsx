...
import { Box, Button, Card, CardContent, CardHeader, Container, Divider, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Tooltip, Typography } from '@mui/material';
      ...
      <Box sx={{ margin: '16px' }}>
        <Card>
          <Box display={'flex'} justifyContent={'space-between'}>
            ...
            <Button variant='contained' startIcon={<ChevronLeftIcon />} sx={{ height: '50%', margin: '16px'}}
              onClick={() => navigate(-1)}
            >Back</Button>
          </Box>
              ...
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell variant='head' align="right">Network Fee&nbsp;(Ar)</TableCell>
                    <TableCell variant='head' align="right">Application Fee&nbsp;(Ar)</TableCell>
                    <TableCell variant='head' align='right'>Model Tx</TableCell>
                    <TableCell variant='head' align='right'>Operation</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {
                          ...
                          <TableCell align="right">
                            <Tooltip title={row.origin}>
                              <Typography display={'flex'}>
                                ...
                                <IconButton
                                  size='small'
                                  onClick={() => {navigator.clipboard.writeText(row.origin);}}
                                >
                                  <ContentCopyIcon fontSize='inherit'/>
                                </IconButton>
                              </Typography>
                          ...
                          <TableCell align="right">
                            <Tooltip title={row.destination}>
                              <Typography display={'flex'}>
                                ...
                                <IconButton
                                  size='small'
                                  onClick={() => {navigator.clipboard.writeText(row.destination);}}
                                >
                                  <ContentCopyIcon fontSize='inherit'/>
                                </IconButton>
                              </Typography>
                          ...
                          <TableCell align="right">
                            <Tooltip title={row.modelTx}>
                              <Typography display={'flex'}>
                                ...
                                <IconButton
                                  size='small'
                                  onClick={() => {navigator.clipboard.writeText(row.modelTx);}}
                                >
                                  <ContentCopyIcon fontSize='inherit'/>
                                </IconButton>
                              </Typography>
