...
const ScriptAttachments = ({ handleShowAttachmentsChanged }: { handleShowAttachmentsChanged: (value: boolean) => void}) => {
  ...
  const handleDownload = useCallback(() => download(state.scriptName, state.scriptTransaction), [ download ]);
...
const ScriptDetails = () => {
  ...
  const handleShowAttachmentsChanged = useCallback((value: boolean) => setShowAttachments(value), [ setShowAttachments ]);
